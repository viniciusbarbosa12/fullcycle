# Lab Phase 6 - Questionnaire and Consolidation
...
- Review Errors.
- Explain with my words every wrong answer.
- Create a personal CI tab.
- Create a final repository by applying everything.
