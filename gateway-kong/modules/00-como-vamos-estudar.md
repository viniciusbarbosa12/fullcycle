...
- API incorrectly exposed in Kubernetes
- Ingress without controller running
- Plugin applied in the wrong route
- OpenID authentication failed
- Invalid or expired token
- OpenAPI contract breaking client
- Pipeline blocking bad contract
- GitOps fixing cluster drift
- Load test revealing neck
- Gateway with high latency
- Insufficient logs to investigate incident
- Error 502 caused by badly configured service
- Lack of default in multiple-time APIs
- Kong operation in production
