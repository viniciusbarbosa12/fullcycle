...
> I'm done, look at my YAML/commands
...
- Microservices hard to observe
- Falls
- Canary deploy in production
- Fast Rollback
- External routes with gateway
- Environmental domains
- Traffic divided between versions
- Debug with Kiali
- Latency between services
- Retry poorly configured
- Circuit breaker too aggressive
- Service Mesh being used without need
- Pure Kubernetes vs Kubernetes with Istio
